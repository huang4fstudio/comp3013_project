<?php
    ...
    function new_auction($item_id, $reserve_price, $end_date,  $seller_id) {
        return db_query("INSERT INTO Auction (id, reserve_price, end_date, item_id, seller_id, highest_bid_id) VALUES (DEFAULT, '$reserve_price', FROM_UNIXTIME('$end_date'), '$item_id', '$seller_id', NULL)");
    }
